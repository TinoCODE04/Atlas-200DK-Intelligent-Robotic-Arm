...
class garbage_identify:
    ...
    def garbage_run(self, image, garbage_index=None):
        ...
        '''
        if garbage_index:
            self.garbage_index = garbage_index # for testing
        ...
        txt0 = 'Model-Loading...'
        msg = {}
        if self.garbage_index < self.WARMUP_INDEX: # 模型预热
    ...
    def get_pos(self):
        ...
        pred, names, drawed_res = infer_image(img, self.model, self.labels_dict, self.cfg)
